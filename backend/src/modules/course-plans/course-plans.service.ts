...
export class CoursePlansService {
  ...
  async update(id: string, dto: UpdateCoursePlanDto): Promise<CoursePlan> {
    if (dto.version === undefined) {
      throw new ConflictException('Version is required for optimistic locking');
    }
    ...
    if (dto.plannedHours !== undefined) updateData.planned_hours = dto.plannedHours;
